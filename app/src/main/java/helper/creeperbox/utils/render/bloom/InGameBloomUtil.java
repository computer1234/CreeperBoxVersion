...
import helper.creeperbox.utils.render.bloom.FrameBuffer;
import helper.creeperbox.utils.render.bloom.GaussianKernel;
...
public class InGameBloomUtil {
    ...
    public InGameBloomUtil(int radius){
        if (bloomShader == null) {
            bloomShader = ShaderUtil.createShader(String.format("#version 320 es\n" +
