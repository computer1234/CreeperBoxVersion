...
public class CBKeyBindingSettingComponent extends CBSettingComponent {
    ...
    public CBKeyBindingSettingComponent(Module module) {
        super(60);
        this.module = module;
    }
    ...
    public void onClick(float x, float y, long time) {
        if(inside(this.x+width-150f,this.y+5f,95f,50f,x,y)){
            module.setKeyBindingToggle(!module.isKeyBindingToggle);
        }
    }
    ...
    public void render() {
        ...
        font.drawString(module.getName()+"快捷键",x+40f,y+font.getMiddle(height),Color.WHITE);
        ...
        toggleAnimation.run(module.isKeyBindingToggle?1f:0f);
