...
inline void AES_EncryptInit(AES_CTX *ctx, const unsigned char *key) {
...
inline void AES_DecryptInit(AES_CTX *ctx, const unsigned char *key) {
...
inline void AES_Encrypt(AES_CTX *ctx, const unsigned char in_data[AES_BLOCK_SIZE], unsigned char out_data[AES_BLOCK_SIZE]) {
...
inline void AES_Decrypt(AES_CTX *ctx, const unsigned char in_data[AES_BLOCK_SIZE], unsigned char out_data[AES_BLOCK_SIZE]) {
	unsigned int s0, s1, s2, s3, t0, t1, t2, t3;
...
inline void AES_CTX_Free(AES_CTX *ctx) {
